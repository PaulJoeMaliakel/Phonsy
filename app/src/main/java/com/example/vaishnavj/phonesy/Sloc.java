            ...
            if (l != null) {
                ...
                try {
                    ...
                    if (!(num1.equals("") || num1.matches(".*[a-zA-Z]+.*"))) {
                        smsManager.sendTextMessage("" + num1, null, Double.toString(l.getLatitude()) + Double.toString(l.getLongitude()), null, null);
                        Toast.makeText(this, "connected", Toast.LENGTH_SHORT).show();
                    }
                    if (!(num2.equals("") || num2.matches(".*[a-zA-Z]+.*"))) {
                        smsManager.sendTextMessage("" + num2, null, Double.toString(l.getLatitude()) + Double.toString(l.getLongitude()), null, null);
                        //Toast.makeText(this, "connected", Toast.LENGTH_SHORT).show();
                    }
                    if (!(num3.equals("") || num3.matches(".*[a-zA-Z]+.*"))) {
                        smsManager.sendTextMessage("" + num3, null, Double.toString(l.getLatitude()) + Double.toString(l.getLongitude()), null, null);
                        //Toast.makeText(this, "connected", Toast.LENGTH_SHORT).show();
                    }
                }
