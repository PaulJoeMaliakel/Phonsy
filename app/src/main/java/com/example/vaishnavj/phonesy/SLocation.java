    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
       ...
       //Toast.makeText(this,"connected",Toast.LENGTH_SHORT).show();
           ...
           // num=intent.getStringExtra("nos");
        {
            ...
            //smsManager.sendTextMessage("9400977209", null, "accident occuered at "+lat+ ""+lon, null, null);
        ...
        try {
            ...
            if (l != null) {
               ...
               /*final ContactInfoDB cid=new ContactInfoDB(this);
                ...
                String num[] = new String[5];
                num[0] = sharedPref.getString("phoneKey1",null);
                ...
                if (!(num[0].matches(".*[a-zA-Z]+.*")||num[0]==""))
                smsManager.sendTextMessage(num[0],null, "accident occuered at http://maps.google.com/?q="+l.getLatitude()+ ","+l.getLongitude(), null, null);
